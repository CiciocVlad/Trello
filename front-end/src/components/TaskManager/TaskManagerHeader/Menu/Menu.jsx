...
export const Menu = ({ setOpen, openSideMenu, setOpenSideMenu, setBackgroundImage }) => {
                ...
                <div className='MenuWrapper'>
                    ...
                    <Collapse in={!openChangeBackground}>
                        <main className='MenuMain'>
                            <ul className='MenuList'>
                                <li className='MenuItem'>Create board</li> <div className='BorderBottom'></div>
                                <li className='MenuItem' onClick={() => setOpenChangeBackground(true)}>Change background</li> <div className='BorderBottom'></div>
                                <li onClick={handleLogout} className='MenuItem'>Logout</li> <div className='BorderBottom'></div>
                            </ul>
                        </main>
                    </Collapse>
                    ...
                    <Collapse in={openChangeBackground}>
                        <div className={classes.menu}>
                            ...
                            ><span className='TextBoxOptions'>Art</span></div>
                            <div className={classes.box}
                                style={{
                            ...
                            ><span className='TextBoxOptions'>Color</span></div>
                        </div>
                        {
                            openOptionImage ? (
