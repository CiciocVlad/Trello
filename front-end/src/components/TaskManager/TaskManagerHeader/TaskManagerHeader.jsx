        ...
        <div>
            <Collapse in={open}>
                <div className="TaskManagerHeader">
                    ...
                    >
                        <TbMenu style={{ marginRight: "5px", fontSize: "1.25rem", fontWeight: "bold" }} />
                        <span>Menu</span>
                    </div>
                    <div
                        onClick={goHome}
            ...
            <Collapse in={!open}>
                <Menu setBackgroundImage={setBackgroundImage} setOpen={setOpen} openSideMenu={openSideMenu} setOpenSideMenu={setOpenSideMenu} />
            </Collapse>
        </div>
    );
}