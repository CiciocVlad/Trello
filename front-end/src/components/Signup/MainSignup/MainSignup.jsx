            ...
            <div className="Auth">
                ...
                <div className="AuthSignupForm">
                    <div className="formFields" id='form'>
                        <div className="FlexBox">
                            <fieldset className='FormControl'>
                                ...
                                <input onChange={e => { setName(e.target.value); console.log(name) }} type="text" name="name" id="name" className='TextInput NameUsername' />
                            ...
                            <fieldset className='FormControl'>
                                ...
                                <input onChange={e => setUsername(e.target.value)} type="text" name="username" id='uname' className='TextInput NameUsername' />
                                <MdVerifiedUser className="MdVerifiedUserFlexBox" />
                                <BsPatchExclamationFill className="BsPatchExclamationFillFlexBox" />
                                <small></small>
                            </fieldset>
                        ...
                        <fieldset className='FormControl'>
                            ...
                            <input onChange={e => setEmail(e.target.value)} type="text" name="email" id='email' className='TextInput Email' />
                        ...
                        <fieldset className='FormControl'>
                            ...
                            <input onChange={e => setPassword(e.target.value)} type="password" placeholder='6+ characters' name="password" id='psw' className='TextInput' />
                            <MdVerifiedUser className="MdVerifiedUser" />
                            <BsPatchExclamationFill className="BsPatchExclamationFill" />
                            <small></small>
                        </fieldset>
                    ...
                    <a href="http://localhost:3000/signin">
                        <button onClick={handleClick} className='formCreate'>Create Account</button>
                    </a>
                </div>
            </div>
        </div >
