...
export const LeftsideSignup = () => {
    ...
    return (
        <div className="LeftsideSignup">
            ...
            <div className="Logo"><a href='https://amarieiandrei.github.io/MyWebsite/html/home' className='LogoHref'>maliakademy</a></div>
            <div className="Text">
            ...
            <div className="Art">
                <span>Art by </span>
                <a href="https://amarieiandrei.github.io/MyWebsite/html/home" className='ArtLink'>Maliakademy</a>
            </div>
        </div>
    );
}
